...
$style = '.variant-item .variant-button{color:inherit;position:relative;}.variant-item .variant-button:focus,.variant-item .variant-button:active,.variant-button:not(.collapsed){box-shadow:none;background-color:transparent;}.variant-item .variant-button:hover,.variant-item .variant-button:focus,.variant-button:not(.collapsed){color:var(--accordion-active-color);}.variant-item .variant-button:after{width:1rem;height:1rem;background-size:1rem;margin-left:auto;margin-right:1rem;color:var(--accordion-active-color);position:absolute;left:0.5rem;}.variant-item .control-group .control-label{width:160px;font-size:0.825rem;font-weight:500;}.j2commerce-variant-general .input-group>.input-group-text{border-radius:var(--border-radius-sm);}.j2commerce-variant-general .input-group>.form-control{border-radius:var(--border-radius-sm);}.j2commerce-variant-form .control-group{margin-bottom:0.5rem;}.j2commerce-variant-form .control-label{font-size:0.825rem;font-weight:500;}.j2commerce-variant-main-image .uppymedia-field{margin-top:0.5rem;}.j2commerce-variant-main-image .uppymedia-preview{gap:0.5rem;--uppymedia-main-image-size:200px;}.j2commerce-variant-main-image .uppymedia-image{max-width:200px;}.j2commerce-variant-main-image .uppymedia-image img{max-height:200px;}.j2commerce-variant-main-image .uppymedia-empty-state{padding:1rem;}.j2commerce-variant-main-image .uppymedia-empty-inner .btn{font-size:0.8rem;}.j2commerce-variant-main-image .uppymedia-add-btn{font-size:0.8rem;}';
...
foreach ($variantList as $variant) :
    ...
    // Load variant forms from component forms directory (fallback in getVariantForms)
    $variantForms = J2CommerceHelper::getVariantForms('variable', $variant, $prefix);
