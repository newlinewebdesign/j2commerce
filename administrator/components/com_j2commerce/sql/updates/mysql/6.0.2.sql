-- J2Commerce 6.0.2 Update
-- Add default data for countries, zones, lengths, and weights tables
...
('COM_J2COMMERCE_GUIDEDTOUR_CREATING_PRODUCT_TITLE', 'j2commerce-creating-product', 'COM_J2COMMERCE_GUIDEDTOUR_CREATING_PRODUCT_DESC', '["com_j2commerce"]', 'administrator/index.php?option=com_j2commerce&view=product&layout=edit', 1, 1, NOW(), NOW(), '*', 1, '', 0),
...
-- Guided Tour Steps: Creating Your First Product
...
CROSS JOIN (
    SELECT 'COM_J2COMMERCE_GUIDEDTOUR_CREATING_PRODUCT_STEP1_TITLE' AS `title`, 'COM_J2COMMERCE_GUIDEDTOUR_CREATING_PRODUCT_STEP1_DESC' AS `description`, 1 AS `ordering`, 'bottom' AS `position`, '#jform_title' AS `target`, 2 AS `type`, 1 AS `interactive_type`, '' AS `url`, 1 AS `published`
    UNION ALL SELECT 'COM_J2COMMERCE_GUIDEDTOUR_CREATING_PRODUCT_STEP2_TITLE', 'COM_J2COMMERCE_GUIDEDTOUR_CREATING_PRODUCT_STEP2_DESC', 2, 'bottom', '#jform_j2commerce_product_type_id', 2, 5, '', 1
    UNION ALL SELECT 'COM_J2COMMERCE_GUIDEDTOUR_CREATING_PRODUCT_STEP3_TITLE', 'COM_J2COMMERCE_GUIDEDTOUR_CREATING_PRODUCT_STEP3_DESC', 3, 'bottom', '.js-j2c-product-price-wrapper input', 2, 1, '', 1
    UNION ALL SELECT 'COM_J2COMMERCE_GUIDEDTOUR_CREATING_PRODUCT_STEP4_TITLE', 'COM_J2COMMERCE_GUIDEDTOUR_CREATING_PRODUCT_STEP4_DESC', 4, 'bottom', '#jform_enabled', 2, 4, '', 1
    UNION ALL SELECT 'COM_J2COMMERCE_GUIDEDTOUR_CREATING_PRODUCT_STEP5_TITLE', 'COM_J2COMMERCE_GUIDEDTOUR_CREATING_PRODUCT_STEP5_DESC', 5, 'bottom', '#toolbar-apply button', 2, 3, '', 1
) s
