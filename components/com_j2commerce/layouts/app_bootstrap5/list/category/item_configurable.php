...
<div class="j2commerce-product-item j2commerce-product-<?php echo $productId; ?> j2commerce-type-<?php echo $product->product_type; ?> <?php echo $cssClass; ?> d-flex flex-column" data-product-id="<?php echo $productId; ?>" data-product-type="<?php echo $product->product_type;?>">
    ...
    <div class="j2commerce-price-sku-container d-flex align-items-center justify-content-between mt-auto">
        <?php if ($showPrice): ?>
