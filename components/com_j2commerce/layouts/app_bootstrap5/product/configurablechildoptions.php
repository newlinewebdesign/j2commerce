...
<?php if (!empty($options)) : ?>
    <?php foreach ($options as $option) : ?>
        ...
        <div id="child-option-<?php echo (int) $option['productoption_id']; ?>" class="option mb-3">
            ...
            <select name="product_option[<?php echo (int) $option['productoption_id']; ?>]" class="form-select"
        ...
        <?php if ($option['type'] === 'color' && !empty($option['optionvalue'])) : ?>
            <div id="option-<?php echo (int) $option['productoption_id']; ?>" class="option mb-3">
                ...
                <div class="j2commerce-color-options d-flex flex-wrap gap-2" data-binded-label="#child-colorOption<?php echo (int) $option['productoption_id']; ?>">
                    <?php foreach ($option['optionvalue'] as $option_value) : ?>
                        <?php $checked = !empty($option_value['product_optionvalue_default']) ? 'checked="checked"' : ''; ?>
                        <input <?php echo $checked; ?> type="radio" name="product_option[<?php echo (int) $option['productoption_id']; ?>]" value="<?php echo (int) $option_value['product_optionvalue_id']; ?>" id="child-option-value-<?php echo (int) $option_value['product_optionvalue_id']; ?>" class="btn-check" onchange="doAjaxFilter(this.value, <?php echo $product_id; ?>, <?php echo (int) $option['productoption_id']; ?>, '#child-option-<?php echo (int) $option['productoption_id']; ?>');" />

                        <label for="child-option-value-<?php echo (int) $option_value['product_optionvalue_id']; ?>" class="btn btn-color fs-xl" title="<?php echo $esc(Text::_($option_value['optionvalue_name'])); ?>" data-label="<?php echo $esc(Text::_($option_value['optionvalue_name'])); ?>" style="color:<?php echo $esc($option_value['optionvalue_image']); ?>;">
