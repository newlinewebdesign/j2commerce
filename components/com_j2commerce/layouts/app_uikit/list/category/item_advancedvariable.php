...
?>
<div class="j2commerce-product-item j2commerce-product-<?php echo $productId; ?> j2commerce-type-advancedvariable <?php echo $cssClass; ?>"
     data-product-id="<?php echo $productId; ?>"
     data-product-type="advancedvariable">
