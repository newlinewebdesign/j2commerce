...
?>
<div class="<?php echo $isQuickview ? 'com_j2commerce ' : ''; ?>j2commerce-single-product <?php echo $this->escape($this->product->product_type ?? ''); ?> detail bs5 py-4 <?php echo $this->escape($productCssClass); ?>">
    ...
    <?php if ($showBackTo && isset($this->back_link) && !empty($this->back_link)) : ?>
        <div class="j2commerce-view-back-button mb-3">
            <a href="<?php echo $this->escape($this->back_link); ?>" class="j2commerce-product-back-btn btn btn-sm btn-info">
                <i class="fa-solid fa-chevron-left"></i> <?php echo Text::_('J2STORE_PRODUCT_BACK_TO') . ' ' . $this->escape($this->back_link_title ?? ''); ?>
            </a>
        </div>
    <?php endif; ?>
