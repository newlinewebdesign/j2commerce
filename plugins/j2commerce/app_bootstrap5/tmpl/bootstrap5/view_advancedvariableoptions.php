...
<div class="options" id="variable-options-<?php echo $productId; ?>" data-product__id="<?php echo $productId; ?>">
    <?php foreach ($options as $option) : ?>
        <?php
        $optionId = (int) $option['productoption_id'];
        ...
        <?php if ($option['type'] === 'select') : ?>
            ...
            <div id="option-<?php echo $optionId; ?>" class="option mb-3">
                ...
                <select name="product_option[<?php echo $optionId; ?>]"
                        data-is-variant="<?php echo $esc($option['is_variant'] ?? ''); ?>"
                    ...
                    <?php foreach ($option['optionvalue'] as $optionValue) : ?>
                        ...
                        <?php $optionValueId = (int) $optionValue['product_optionvalue_id']; ?>
                        <option <?php echo $checked; ?> value="<?php echo $optionValueId; ?>">
                            ...
                            <?php if ($optionValue['product_optionvalue_price'] > 0 && $this->params->get('product_option_price', 1)) : ?>
                                (<?php if ($this->params->get('product_option_price_prefix', 1)) : ?><?php echo $esc($optionValue['product_optionvalue_prefix']); ?><?php endif; ?>
            ...
            <div id="option-<?php echo $optionId; ?>" class="option pb-3 mb-2 mb-lg-3">
                ...
                <div class="d-flex flex-wrap gap-2">
                    <?php foreach ($option['optionvalue'] as $optionValue) : ?>
                        <?php
                        $checked = '';
                        $optionValueId = (int) $optionValue['product_optionvalue_id'];
                        if ($optionValue['product_optionvalue_default']) {
                            $checked = ' checked="checked"';
                            $checkedOptionId = $optionValueId;
                        }
                        ?>
                        <div class="radio--btn option_li--<?php echo $optionValueId; ?>">
                            <input<?php echo $checked; ?> type="radio"
                                   name="product_option[<?php echo $optionId; ?>]"
                                   data-is-variant="<?php echo $esc($option['is_variant'] ?? ''); ?>"
                                   value="<?php echo $optionValueId; ?>"
                                   id="option-value-<?php echo $optionValueId; ?>"
                                   class="btn-check j2c-option-radio<?php echo $radioDisabled; ?>"
                                   data-product-id="<?php echo $productId; ?>"
                                   data-option-id="<?php echo $optionId; ?>" />
                            <label for="option-value-<?php echo $optionValueId; ?>" class="btn btn-sm btn-outline-secondary">
                                <?php if ($this->params->get('image_for_product_options', 0) && isset($optionValue['optionvalue_image']) && !empty($optionValue['optionvalue_image'])) : ?>
                                    <img class="optionvalue-image-<?php echo $optionId; ?>-<?php echo $optionValueId; ?>" src="<?php echo Uri::root(true) . '/' . $esc($optionValue['optionvalue_image']); ?>" alt="" />
                                <?php endif; ?>
                                <?php echo $esc(Text::_($optionValue['optionvalue_name'])); ?>
                                <?php if ($optionValue['product_optionvalue_price'] > 0 && $this->params->get('product_option_price', 1)) : ?>
                                    (<?php if ($this->params->get('product_option_price_prefix', 1)) : ?><?php echo $esc($optionValue['product_optionvalue_prefix']); ?><?php endif; ?>
                ...
                <?php foreach ($option['optionvalue'] as $optionValue) : ?>
                    ...
                    <div class="form-check form-check-inline">
                        <input type="checkbox"
                               ...
                               data-product-id="<?php echo $productId; ?>"
                               data-option-id="<?php echo $optionId; ?>" />
                        <label for="option-value-<?php echo $optionValueId; ?>" class="form-check-label">
                            <?php echo $esc(Text::_($optionValue['optionvalue_name'])); ?>
                            <?php if ($optionValue['product_optionvalue_price'] > 0 && $this->params->get('product_option_price', 1)) : ?>
                                (<?php if ($this->params->get('product_option_price_prefix', 1)) : ?><?php echo $esc($optionValue['product_optionvalue_prefix']); ?><?php endif; ?>
                                <?php echo $productHelper->displayPrice($optionValue['product_optionvalue_price'], $this->product, $this->params); ?>)
        ...
        <?php if ($option['type'] === 'date') : ?>
            <?php $elementDate = 'j2commerce_date_' . $optionId; ?>
            <!-- date -->
            <div id="option-<?php echo $optionId; ?>" class="option mb-3">
                <div class="mb-2">
                    <label class="form-label fw-bold d-flex">
                ...
                <input type="text"
                       name="product_option[<?php echo $optionId; ?>]"
                       value="<?php echo $esc($option['optionvalue'] ?? ''); ?>"
                       class="<?php echo $elementDate; ?> form-control" />
            </div>
            <?php J2CommerceHelper::strapper()->addDatePicker($elementDate, $option['option_params']); ?>
        <?php endif; ?>

        <?php if ($option['type'] === 'datetime') : ?>
            <?php $elementDatetime = 'j2commerce_datetime_' . $optionId; ?>
            <!-- datetime -->
            <div id="option-<?php echo $optionId; ?>" class="option mb-3">
                <div class="mb-2">
                    <label class="form-label fw-bold d-flex">
                ...
                <input type="text"
                       name="product_option[<?php echo $optionId; ?>]"
                       value="<?php echo $esc($option['optionvalue'] ?? ''); ?>"
                       class="<?php echo $elementDatetime; ?> form-control" />
            </div>
            <?php J2CommerceHelper::strapper()->addDateTimePicker($elementDatetime, $option['option_params']); ?>
        <?php endif; ?>
