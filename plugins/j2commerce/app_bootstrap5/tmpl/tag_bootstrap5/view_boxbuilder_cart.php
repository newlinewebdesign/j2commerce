...
<?php if (J2CommerceHelper::product()->validateVariableProduct($this->product)): ?>
    ...
    <div id="add-to-cart-<?php echo $productId; ?>" class="j2commerce-add-to-cart d-flex flex-wrap flex-sm-nowrap flex-md-wrap flex-lg-nowrap gap-3 gap-lg-2 gap-xl-3 mb-4 mt-4">
        <?php if ($show_qty_btn): ?>
            <?php echo J2CommerceHelper::product()->displayQuantity('com_j2commerce.product.bootstrap5', $this->product, $this->params, ['class' => 'form-control']); ?>
        <?php else: ?>
