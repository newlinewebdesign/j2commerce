...
<div class="j2commerce-product-options py-2" id="product-options-<?php echo $productId; ?>">
    ...
    <div class="collapse pt-2" id="collapseOptions<?php echo $productId; ?>">
        <?php foreach ($options as $option) : ?>
            ...
            <?php if ($option['type'] == 'select' && isset($option['optionvalue']) && !empty($option['optionvalue'])) : ?>
                <div id="option-<?php echo (int) $option['productoption_id']; ?>" class="option mb-3">
                    ...
                    <select name="product_option[<?php echo (int) $option['productoption_id']; ?>]" class="form-select" data-product-id="<?php echo $productId; ?>" data-option-id="<?php echo (int) $option['productoption_id']; ?>" onchange="doAjaxFilter(this.options[this.selectedIndex].value, <?php echo $productId; ?>, <?php echo (int) $option['productoption_id']; ?>, '#option-<?php echo (int) $option['productoption_id']; ?>')">
                ...
                <div id="option-<?php echo (int) $option['productoption_id']; ?>" class="option mb-3">
                    ...
                    <div class="j2commerce-radio-options d-flex flex-wrap gap-2" data-binded-label="#radioOption<?php echo (int) $option['productoption_id']; ?>">
                        <?php foreach ($option['optionvalue'] as $option_value) : ?>
                            ...
                            <input <?php echo $checked; ?> type="radio" name="product_option[<?php echo (int) $option['productoption_id']; ?>]" value="<?php echo (int) $option_value['product_optionvalue_id']; ?>" id="option-value-<?php echo (int) $option_value['product_optionvalue_id']; ?>" class="btn-check" data-product-id="<?php echo $productId; ?>" data-option-id="<?php echo (int) $option['productoption_id']; ?>" autocomplete="off" onchange="doAjaxFilter(this.value, <?php echo $productId; ?>, <?php echo (int) $option['productoption_id']; ?>, '#option-<?php echo (int) $option['productoption_id']; ?>')" />
                ...
                <div id="option-<?php echo (int) $option['productoption_id']; ?>" class="option mb-3">
                    ...
                    <div class="j2commerce-color-options d-flex flex-wrap gap-2" data-binded-label="#colorOption<?php echo (int) $option['productoption_id']; ?>">
                        <?php foreach ($option['optionvalue'] as $option_value) : ?>
                            ...
                            <input <?php echo $checked; ?> type="radio" name="product_option[<?php echo (int) $option['productoption_id']; ?>]" value="<?php echo (int) $option_value['product_optionvalue_id']; ?>" id="option-value-<?php echo (int) $option_value['product_optionvalue_id']; ?>" class="btn-check" data-product-id="<?php echo $productId; ?>" data-option-id="<?php echo (int) $option['productoption_id']; ?>" onchange="doAjaxFilter(this.value, <?php echo $productId; ?>, <?php echo (int) $option['productoption_id']; ?>, '#option-<?php echo (int) $option['productoption_id']; ?>')" />
        ...
        <?php if ($option['type'] == 'checkbox' && isset($option['optionvalue']) && !empty($option['optionvalue'])) : ?>
            <div id="option-<?php echo (int) $option['productoption_id']; ?>" class="option mb-3" data-config-checkbox="1" data-product-id="<?php echo $productId; ?>" data-po-id="<?php echo (int) $option['productoption_id']; ?>">
                <?php if ($option['required']) : ?>
                    <span class="text-danger">*</span>
                <?php endif; ?>
