...
?>
<div class="j2commerce-product-item j2commerce-product-<?php echo $productId; ?> j2commerce-type-<?php echo htmlspecialchars($product->product_type ?? '', ENT_QUOTES, 'UTF-8'); ?> <?php echo $cssClass; ?>" data-product-id="<?php echo $productId; ?>" data-product-type="<?php echo htmlspecialchars($product->product_type ?? '', ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <?php if ($showCart): ?>
        <form action="<?php echo htmlspecialchars($product->cart_form_action ?? '', ENT_QUOTES, 'UTF-8'); ?>"
              ...
              data-product_type="<?php echo htmlspecialchars($product->product_type ?? '', ENT_QUOTES, 'UTF-8'); ?>"
            ...
            <?php elseif (($cartType == 2 && !empty($product->options)) || $cartType == 3) : ?>
                <a href="<?php echo $esc($productLink ?? ''); ?>" class="btn btn-outline-primary">
