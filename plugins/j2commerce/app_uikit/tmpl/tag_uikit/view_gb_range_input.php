...
<div class="gb-range-field" data-step="<?php echo $stepNum; ?>">
    ...
    <div class="gb-range-help uk-text-small uk-text-muted uk-margin-small-top">
        <?php
        $sign = $pricePerUnit > 0 ? '+' : '';
    ...
    <?php if ($helpText !== '') : ?>
    <div class="gb-range-help uk-text-small uk-text-muted uk-margin-small-top"><?php echo $helpText; ?></div>
    <?php endif; ?>
