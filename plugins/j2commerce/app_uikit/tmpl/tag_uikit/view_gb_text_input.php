...
<div class="gb-text-field" data-step="<?php echo $stepNum; ?>">
    ...
    <?php if ($maxLength > 0) : ?>
    <div class="gb-text-char-count uk-flex uk-flex-right uk-margin-small-top">
    ...
    <?php if ($helpText !== '') : ?>
    <div class="uk-text-muted uk-text-small"><?php echo $helpText; ?></div>
    <?php endif; ?>
